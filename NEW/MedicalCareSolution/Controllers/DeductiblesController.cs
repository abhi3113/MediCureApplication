...
namespace HealthPlanPortal.Controllers
{
    public class DeductiblesController : Controller
    {
        ...
        {
            var deductibles = db.Deductibles.Include(d => d.HealthPlan);
            return View(deductibles.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "DeductibleId,HealthPlanId,DeductibleCode,IndividualDedAmt,FamilyDedAmt,MaxDeductibleAmountPerIndividual,ServicesCoveredBeforeDeductibleMetBool,DeductibleIncdInOutOfPcktBool,AnnualLimitsPlanBool,AnnualPremium,CoinsuranceUpper,CoinsuranceLower,AnnualLimitHigher,AnnualLimitLower,TotalEstimatedCost")] Deductible deductible)
        {
            ...
            ViewBag.HealthPlanId = new SelectList(db.HealthPlans, "HealthPlanId", "HealthPlanCode", deductible.HealthPlanId);
            return View(deductible);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DeductibleId,HealthPlanId,DeductibleCode,IndividualDedAmt,FamilyDedAmt,MaxDeductibleAmountPerIndividual,ServicesCoveredBeforeDeductibleMetBool,DeductibleIncdInOutOfPcktBool,AnnualLimitsPlanBool,AnnualPremium,CoinsuranceUpper,CoinsuranceLower,AnnualLimitHigher,AnnualLimitLower,TotalEstimatedCost")] Deductible deductible)
        {
            if (ModelState.IsValid)
            {
